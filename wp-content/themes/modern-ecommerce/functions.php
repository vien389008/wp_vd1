...
function modern_ecommerce_fonts_scripts() {
	$headings_font = esc_html(get_theme_mod('modern_ecommerce_headings_text'));
	$body_font = esc_html(get_theme_mod('modern_ecommerce_body_text'));

	if( $headings_font ) {
		wp_enqueue_style( 'modern-ecommerce-headings-fonts', '//fonts.googleapis.com/css?family='. $headings_font );
	} else {
		wp_enqueue_style( 'modern-ecommerce-source-sans', '//fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic');
	}
	if( $body_font ) {
		wp_enqueue_style( 'modern-ecommerce-body-fonts', '//fonts.googleapis.com/css?family='. $body_font );
	} else {
